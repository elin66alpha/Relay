...
- BTW (by the way) sidekick lets you ask read-only questions that fork the main session without disturbing the task.
...
<p>
  ...
  <img src="assets/screenshots/relay-mobile-cards-en.png" alt="Card mode" width="260">
